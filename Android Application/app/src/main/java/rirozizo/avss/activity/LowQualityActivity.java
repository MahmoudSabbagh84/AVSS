...
public class LowQualityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (con.login("pi", "pipipass")) {
                ...
                boolean result = con.retrieveFile("image-compressed.jpg", out);
                out.close();
                ...
                mypath = new File(Environment.getExternalStorageDirectory().getPath(), "avss-compressed-"+time+".jpg");
